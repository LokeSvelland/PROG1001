...
const int FIBANT = 20;          ///<  Max. antall i Fibonacci-array.
...
// ***************************************************************************
    ...
    int FibonacciTall[20] =  { 1, 1 };  //  Definerer og DELVIS initierer!
 ...
 */
char* finnTegnITekst(char* tekst, const char tegn)  {
   while (*tekst)  {                  //  Letet gjennom teksten fren til '\0'.
                                      //  Tegnet funnet -
...
}     //  NB:  Læreboka har en litt annen løsning på dette i Prog.10.11 s.262